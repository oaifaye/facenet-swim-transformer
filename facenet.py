...
class Facenet(object):
    _defaults = {
        ...
        # "model_path"    : "model_data/Epoch17-Total_Loss0.2239.pth-Val_Loss1.3329.pth",
        # "model_path"    : "model_data/Epoch100-Total_Loss0.1446.pth-Val_Loss1.3437.pth",
        # "model_path": "model_data/Epoch7-Total_Loss0.1318.pth-Val_Loss0.1428.pth",
        # "model_path": "model_data/Epoch12-Total_Loss0.1354.pth-Val_Loss0.1450.pth",
        "model_path": "model_data/Epoch31-Total_Loss0.1126.pth-Val_Loss0.1247.pth",
    ...
    #   检测图片
    #---------------------------------------------------#
    def detect_image(self, image_1, image_2, show_plt=True):
        #---------------------------------------------------#
        #   图片预处理，归一化
        #---------------------------------------------------#
        with torch.no_grad():
