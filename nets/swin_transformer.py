...
#================================================================
#
#   File name   : swin_transformer.py
#   Author      : Faye
#   Created date: 2022/4/27 16:18 
#   Description :
#
#================================================================
...
if __name__ == '__main__':
    ...
    # model.load_state_dict(torch.load("../model_data/resnet152-b121ed2d.pth", map_location='cpu'))
    input = np.random.random((1, 3, 160, 160))
    input = input.astype(np.float32)
    input = torch.from_numpy(input)
    output = model(input)
    # torch.save(model.state_dict(), "../model_data/resnet18.pth")
    # torch.save(model.state_dict(), "../model_data/resnet152-b121ed2d.pth")
    print(output.size())
